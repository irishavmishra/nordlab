...
const tiers = [
  ...
  },
  {
    ...
    featured: false,
    badge: null,
    href: "mailto:hello@nordlab.online",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-warm-gray/60 text-base max-w-xl mx-auto leading-relaxed">
            Start free. Scale as you grow. No hidden fees, no long-term contracts. Cancel anytime.
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tiers.map((tier) => (
            <div
              key={tier.label}
              className={`relative border transition-all duration-300 ${tier.featured ? "border-copper/40 bg-charcoal/60" : "border-warm-gray/10 bg-charcoal/30 hover:border-warm-gray/20"}`}
            >
              {tier.badge && (
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="mt-4 mb-6">
                  ...
                  {annual && tier.priceMonthly !== "Free" && tier.priceMonthly !== "Custom" && (
                    <p className="text-warm-gray/30 text-xs mt-1">billed annually</p>
                  )}
                </div>
                ...
                <ul className="space-y-3 mb-8">
                  {tier.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-2 text-warm-gray/60 text-sm">
                      <svg className="w-4 h-4 text-copper/60 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                {tier.label === "Enterprise" ? (
                  <a
                    href={tier.href}
                    className={`block text-center py-3 text-sm font-medium tracking-wide transition-colors ${tier.featured ? "btn-copper text-obsidian" : "bg-warm-gray/10 text-cream hover:bg-warm-gray/15"}`}
                  >
                    {tier.cta}
                  </a>
                ) : (
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-warm-gray/10 pb-6">
              ...
              <p className="text-warm-gray/50 text-sm leading-relaxed">
                Yes! Growth and Pro plans include a 14-day free trial. No credit card required to start.
              </p>
            </div>
            <div className="border-b border-warm-gray/10 pb-6">
